...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.hebei.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin bluetooth_low_energy_android, dev.hebei.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin", e);
    }
    try {
